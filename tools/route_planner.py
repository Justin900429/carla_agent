# Adapted from https://github.com/basiclab/TTSG/blob/main/agents/navigation/global_route_planner.py
...
class GlobalRoutePlanner:
    ...
    def trace_route(self, origin, destination, point_only: bool = False):
        ...
        if point_only:
            route_trace = [waypoint for waypoint, _ in route_trace]
        return route_trace
    ...
    def _turn_decision(self, index, route, threshold=TURN_THRESHOLD):
        """
